...
use TaxiCoBundle\Form\ServiceType;
...
class ServiceController extends Controller
{
    ...
    {   //create an object to store our data after the form submission
        ...
        return $this->render('@TaxiCo/Maintenance/create.html.twig', array(
    ...
    {
        $em=$this->getDoctrine()->getManager();
        $find=$this->getDoctrine()->getRepository(Service::class)->find($id);
        $form = $this->createForm(ServiceType::class,$find);
